...
public class DecryptResource extends CordovaPlugin {
    ...
    private static final String CRYPT_KEY = "es416/i8nWgUecuJ5naG5Q5B6m58APy6";
    private static final String CRYPT_IV = "ZGJavzxRblky0gtg";
    private static final String[] INCLUDE_FILES = new String[] { "\\.(htm|html|js|css)$" };
    private static final String[] EXCLUDE_FILES = new String[] { "arworld\\.js$", "arworld\\.html$", "arworld\\.css$", "architect\\.js$", "ade\\.js$" };
